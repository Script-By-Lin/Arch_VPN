...
export const CLI_COMMANDS: CliCommand[] = [
  {
    command: "shadowtun connect [TARGET]",
    ...
    example: "shadowtun connect a1b2c3d4",
...
[✓] Connected successfully!
  ...
  {
    command: "shadowtun switch <TARGET>",
    ...
    example: "shadowtun switch f7c320d9",
    output: `[*] Preparing connection...
...
[✓] Disconnected successfully. Default routes and DNS restored.`
  ...
  },
  {
    ...
    example: "shadowtun import \"ssconf://sub.example.com/api/v1/sub_token123.json#Tokyo-Fast-01\"",
...
To connect: shadowtun connect a1b2c3d4`
  },
  {
...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    category: "Routing",
    answer: "You can view all saved profiles and their 8-character IDs with `shadowtun list`, then switch immediately using `shadowtun switch <ID>` or `shadowtun connect <ID>`. Short prefix matching (e.g. first 4 characters) and profile names are supported, and active VPN tunnels will switch seamlessly without manual disconnection.",
  ...
  },
  {
    ...
    category: "Routing",
    answer: "Run `shadowtun logs -f` (or `shadowtun logs --follow`). ShadowTun will display initial recent entries and stream all newly appended connection, DNS, and proxy events in real time with formatted tags.",
